...
※ لاظهار كيبورد الاعضاء اضغط /AFYN \n
...
※ استخدم الازرار لمعرفه الاوامر المستخدمه. """,
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [InlineKeyboardButton("", url=f"https://t.me/BxxBxxL"),
...
InlineKeyboardButton("لتفعيل كيبورد الاعضاء", callback_data="afyona"),
                ...
                [
                    InlineKeyboardButton(
                        "‹ السورس ›", url=f"https://t.me/xLxLxLrr3"
                    ),
                    InlineKeyboardButton(
                        "‹ اضف البوت لمجموعتك ›", url=f"https://t.me/BlacMusic_Bot?startgroup=true"
                    ),
                ],
                [
                    InlineKeyboardButton(
                        "", url="https://t.me/BxxBxxL"
                    )
                ],
            ]
        ),
...
\n√ **في حال واجهت اي مشكلة اخرى يمكنك التواصل مع المطور من هنا : @IIIlIIv **
\n __ Developer """,
        reply_markup=InlineKeyboardMarkup(
